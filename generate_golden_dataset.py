...
def generate_dataset():
            ...
            dataset.append(
                {
                    ...
                    "source": random.choice(
                        ["Reuters", "Bloomberg", "ArXiv", "TechCrunch", "Unknown Blog"]
                    ),
                    "published": pub_date,
    ...
    add_items(
        medium_impact_templates, 40, time_offset_days=1
    )  # 40 Notizie medie di ieri
    add_items(low_impact_templates, 40, time_offset_days=0)  # 40 Notizie inutili
    add_items(
        hard_negatives, 20, time_offset_days=1000
    )  # 20 Hard negatives (vecchie/ingannevoli)
