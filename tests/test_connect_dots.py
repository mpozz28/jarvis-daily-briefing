...
def test_connect_the_dots(monkeypatch):
    ...
    mock_news = [
        {"id": "1", "domain": "Research AI", "title": "OpenAI lancia GPT-5", "summary": "Nuovo modello di Sam Altman"},
        {"id": "2", "domain": "Finance", "title": "MSFT sale del 3%", "summary": "Crescita spinta da cloud e AI"}
    ]
...
def test_connect_the_dots_no_correlation(monkeypatch):
    ...
    mock_news = [
        {"id": "3", "domain": "Research AI", "title": "OpenAI lancia GPT-5", "summary": "..."},
        {"id": "4", "domain": "Finance", "title": "Apple annuncia nuovi iPhone", "summary": "..."}
    ]
